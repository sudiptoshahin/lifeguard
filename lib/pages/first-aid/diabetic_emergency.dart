...
class DiabeticEmergency extends StatelessWidget {

  DiabeticEmergency({Key? key}) : super(key: key);
  int _currentIndex = 1;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image(image: AssetImage('assets/images/diabatic_emergency_banner.jpg'), fit: BoxFit.cover,)
                  ),

                  Container(
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.only(top: 10.0, bottom: 10.0, left: 10.0),
                    child: Text('Diabetic Emergency', style: AppStrings.heading2Style(),),
                  ),


                  Expanded(child: _itemText(context, AppStrings.diabeticText),),
                  SizedBox(height: 100,),
                ],
              ),
            ),
