...
class PoisoningHarmfulSubstance extends StatelessWidget {
  PoisoningHarmfulSubstance({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image(image: AssetImage('assets/images/poison_banner.jpg'), fit: BoxFit.cover,)
                  ),

                  Container(
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.only(top: 10.0, bottom: 10.0, left: 10.0),
                    child: Text('Poisoning or Harmful Substances', style: AppStrings.heading2Style(),),
                  ),


                  Expanded(child: _itemText(context, AppStrings.poisoningHarmfulSubstanceText),),
                  SizedBox(height: 100,),
                ],
              ),
            ),
