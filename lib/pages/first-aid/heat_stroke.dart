...
class HeatStroke extends StatelessWidget {
  HeatStroke({Key? key}) : super(key: key);
  int _currentIndex = 1;
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image(image: AssetImage('assets/images/heat_stroke_banner.png'), fit: BoxFit.cover,)
                  ),

                  Container(
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.only(top: 10.0, bottom: 10.0, left: 10.0),
                    child: Text('Heat Stroke', style: AppStrings.heading2Style(),),
                  ),


                  Expanded(child: _itemText(context, AppStrings.heatStrokeText),),
                  SizedBox(height: 150),
