...
class StrianSprain extends StatelessWidget {
  StrianSprain({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image(image: AssetImage('assets/images/strain_banner.jpg'), fit: BoxFit.cover,)
                  ),

                  Container(
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.only(top: 10.0, bottom: 10.0, left: 10.0),
                    child: Text('Strains and Sprains', style: AppStrings.heading2Style(),),
                  ),


                  Expanded(child: _itemText(context, AppStrings.strainsAndSpineText),),
                  SizedBox(height: 100,),
