...
class StingAnimal extends StatelessWidget {
  StingAnimal({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image(image: AssetImage('assets/images/animals_banner.jpg'), fit: BoxFit.cover,)
                  ),

                  Container(
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.only(top: 10.0, bottom: 10.0, left: 10.0),
                    child: Text(AppStrings.stingbites_related_item6_title, style: AppStrings.heading2Style(),),
                  ),


                  Expanded(child: _itemText(context, AppStrings.stingbites_related_item6_text),),
                  SizedBox(height: 100,),
                ],
              ),
            ),
