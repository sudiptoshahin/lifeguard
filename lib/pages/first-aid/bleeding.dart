              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image(image: AssetImage('assets/images/bleeding_banner.jpg'), fit: BoxFit.cover,)
                  ),

                  Container(
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.only(top: 10.0, bottom: 10.0, left: 10.0),
                    child: Text('Bleeding', style: AppStrings.heading2Style(),),
                  ),


                  Expanded(child: _itemText(context, AppStrings.bleedingText),),
                  SizedBox(height: 100,),
