...
class VideoLink5 extends StatefulWidget {
  const VideoLink5({Key? key}) : super(key: key);

  @override
  _VideoLink5State createState() => _VideoLink5State();
}

class _VideoLink5State extends State<VideoLink5> {
  int _currentIndex = 3;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: WebView(
          initialUrl: 'https://youtu.be/0bat6R9UOuM',
