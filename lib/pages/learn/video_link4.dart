...
class VideoLink4 extends StatefulWidget {
  const VideoLink4({Key? key}) : super(key: key);

  @override
  _VideoLink4State createState() => _VideoLink4State();
}

class _VideoLink4State extends State<VideoLink4> {
  int _currentIndex = 3;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: WebView(
          initialUrl: 'https://youtu.be/qQLL3bqNMx4',
